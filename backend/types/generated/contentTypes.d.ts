...
export interface ApiOrderHistoryOrderHistory extends Schema.CollectionType {
  ...
  info: {
    ...
    description: '\u8BA2\u5355\u72B6\u6001\u53D8\u66F4\u5386\u53F2\u8BB0\u5F55 - \u8BB0\u5F55\u6BCF\u6B21\u8BA2\u5355\u72B6\u6001\u7684\u53D8\u66F4\uFF0C\u5305\u62EC\u65E7\u72B6\u6001\u3001\u65B0\u72B6\u6001\u3001\u53D8\u66F4\u65F6\u95F4\u548C\u64CD\u4F5C\u4EBA';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    order: Attribute.Relation<
      ...
      'api::order.order'
    >;
    fromStatus: Attribute.Enumeration<
      ['pending', 'processing', 'shipped', 'completed', 'cancelled']
    >;
    toStatus: Attribute.Enumeration<
      ['pending', 'processing', 'shipped', 'completed', 'cancelled']
    > &
      Attribute.Required;
    changedBy: Attribute.Relation<
      'api::order-history.order-history',
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    note: Attribute.Text;
    changedAt: Attribute.DateTime &
      Attribute.Required &
...
export interface ApiUserAddressUserAddress extends Schema.CollectionType {
  ...
  info: {
    ...
    description: '\u7528\u6237\u6536\u8D27\u5730\u5740 - \u7BA1\u7406\u7528\u6237\u7684\u6536\u8D27\u5730\u5740\u4FE1\u606F\uFF0C\u652F\u6301\u8BBE\u7F6E\u9ED8\u8BA4\u5730\u5740';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    receiverPhone: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        maxLength: 20;
      }>;
    ...
    detailAddress: Attribute.Text & Attribute.Required;
