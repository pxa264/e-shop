      ...
      <main>
        {banners.data && banners.data.length > 0 ? (
          ...
          <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-32">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
              <h1 className="text-5xl md:text-7xl font-extrabold mb-8 tracking-tight">{t('home.welcomeTitle')}</h1>
              <p className="text-xl md:text-2xl mb-12 text-primary-50 max-w-2xl mx-auto leading-relaxed">{t('home.welcomeSubtitle')}</p>
              <Link
                href="/products"
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="flex items-end justify-between mb-12">
            <div>
              <h2 className="text-3xl font-extrabold text-gray-900 mb-2">{t('home.hot')}</h2>
            ...
            <Link href="/products" className="text-primary-600 font-semibold hover:text-primary-700 flex items-center group">
              {t('home.viewAll')} <ChevronRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
            </Link>
          </div>
              ...
              products.data.map((product: any) => (
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <p className="text-gray-500 text-sm mb-6 line-clamp-2 flex-1">{product.attributes.description}</p>
